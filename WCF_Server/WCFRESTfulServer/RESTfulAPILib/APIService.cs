...
namespace RESTfulAPILib
{
    ...
    public class APIService : IAPIService
    {
        ...
        // http://localhost:23333/APIService/TestEcho3
        [WebInvoke(Method = "POST",
                    RequestFormat = WebMessageFormat.Json,
                    ResponseFormat = WebMessageFormat.Json,
                    UriTemplate = "TestEcho3")]
        ...
        // http://localhost:10301/GameService/DevPushInfo
		[WebInvoke(Method = "POST",
					RequestFormat = WebMessageFormat.Json,
					UriTemplate = "DevPushInfo")]
		public void DevPushInfo(REQ_DEV_PUSH_INFO requestData)
		{
            var msg = string.Format("UserID:{0}, DeviceRegistedId: {1}", requestData.UserID, requestData.RegistID);
			CommonServer.FileLogger.Info(msg);
		}
